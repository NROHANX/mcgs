...
import { Shield, CheckCircle, AlertTriangle, User, Mail, Lock, Trash2, Users, Wrench } from 'lucide-react';
import Button from '../components/ui/Button';
import { setupAllUsers, createAdminUser, createProviderUser, createCustomerUser, clearAuthUsers } from '../utils/setupUsers';
...
const AdminSetup: React.FC = () => {
  ...
  const handleClearData = async () => {
    setLoading(true);
    try {
      const result = await clearAuthUsers();
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center">
                  ...
                  <span className="font-mono">{credentials.admin.email}</span>
                </div>
                <div className="flex items-center">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center">
                  ...
                  <span className="font-mono">{credentials.provider.email}</span>
                </div>
                <div className="flex items-center">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center">
                  ...
                  <span className="font-mono">{credentials.customer.email}</span>
                </div>
                <div className="flex items-center">
            ...
            <div className="flex items-center">
              ...
              <div className="text-orange-800 text-sm">
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>Clear Database will remove all existing users and data</li>
                  <li>Setup Users will create the three test accounts with your specified credentials</li>
                  <li>All users are created with "approved" status for immediate access</li>
                  <li>Use the test login buttons to verify each account works correctly</li>
                </ul>
              </div>
            </div>
          </div>
