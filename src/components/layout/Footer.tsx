      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link 
                  to="/become-provider"
                  className="text-gray-400 hover:text-white transition-colors hover:text-yellow-400"
                >
          ...
          <div>
            ...
            <div className="mt-6">
              <h4 className="text-sm font-semibold mb-3 text-green-300">Support Status</h4>
