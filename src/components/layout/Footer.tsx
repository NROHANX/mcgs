...
import ProviderRegistrationModal from '../ui/ProviderRegistrationModal';
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <button 
                    ...
                    className="text-gray-400 hover:text-white transition-colors text-left hover:text-yellow-400"
                  >
