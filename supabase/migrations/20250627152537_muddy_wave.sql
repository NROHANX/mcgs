/*
  ...
  1. New Tables
    ...
    - `service_bookings` - Customer service booking requests
    - `booking_assignments` - Assignment of bookings to providers
...
-- Clean up existing policies and triggers for users
DO $$ 
BEGIN
...
-- Clean up existing policies for service_categories
DO $$ 
BEGIN
...
-- Clean up existing policies for service_areas
DO $$ 
BEGIN
...
-- Clean up existing policies for service_providers
DO $$ 
BEGIN
...
-- Clean up existing policies for provider_categories
DO $$ 
BEGIN
...
-- Clean up existing policies for provider_service_areas
DO $$ 
BEGIN
...
-- Clean up existing policies for services
DO $$ 
BEGIN
...
-- Clean up existing policies and triggers for service_bookings
DO $$ 
BEGIN
...
-- Clean up existing policies for booking_assignments
DO $$ 
BEGIN
...
-- Clean up existing policies and triggers for reviews
DO $$ 
BEGIN
...
-- Clean up existing policies for contacts
DO $$ 
BEGIN
...
-- Clean up existing policies and triggers for support_tickets
DO $$ 
BEGIN
...
-- Clean up existing policies for admin_management
DO $$ 
BEGIN
...
-- Clean up existing policies and triggers for user_roles
DO $$ 
BEGIN
