/*
  ...
  1. New Tables
    - `user_registration_requests`
      ...
      - `provider_details` (jsonb, optional)
  ...
  2. Security
    ...
    - Create functions for approval workflow

  3. Functions
    - `approve_user_registration()` - Approve registration requests
    - `reject_user_registration()` - Reject registration requests
